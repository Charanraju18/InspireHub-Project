          ...
          <div className="col-lg-8 pe-lg-5">
            ...
            <div className="event-item-wrapper overflow-x-auto scroll-sm scroll-sm-horizontal pb-4">
              {eventsData.map((event, index) => (
                <div
                  key={event.id}
                  className={`event-item bg-main-25 rounded-12 p-24 d-flex align-items-center border border-neutral-20 min-width-max-content hover-bg-main-600 hover-border-main-600 hover-text-white transition-1 mb-${
                    index === eventsData.length - 1 ? 0 : 24
                  }`}
                  data-aos="fade-up-left"
                  data-aos-duration={event.aosDuration}
                >
                  <div>
                    <h3 className="mb-8 text-main-600">{event.date}</h3>
                    <span className="text-neutral-500">{event.monthYear}</span>
                  </div>
                  <span className="border border-neutral-40 border-dashed h-72" />
                  <div>
                    <div className="flex-between gap-16 flex-wrap mb-16">
                    ...
                    <h4 className="mt-12 mb-0">{event.title}</h4>
                  </div>
                  <span className="border border-neutral-40 border-dashed h-72" />
                  <div className="flex-shrink-0">
                    <Link
